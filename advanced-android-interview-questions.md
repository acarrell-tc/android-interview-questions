...
* [38. When you should use weak references or soft references to manage memory in Android applications?](#38-when-you-should-use-weak-references-or-soft-references-to-manage-memory-in-android-applications)
